  ...
  factory: (require) => {
    ...
    function VoicePanel() {
      ...
      return React.createElement("div", { className: "wv-page" },
        React.createElement("style", null, `.wv-page{max-width:760px;padding:8px 4px 40px;color:inherit}.wv-group{border:1px solid color-mix(in srgb,currentColor 16%,transparent);border-radius:14px;padding:18px;background:color-mix(in srgb,currentColor 4%,transparent)}.wv-field{display:flex;flex-direction:column;gap:6px;margin:13px 0;font-size:13px}.wv-field select,.wv-field input{padding:9px;border:1px solid color-mix(in srgb,currentColor 22%,transparent);border-radius:8px;background:transparent;color:inherit}.wv-row{display:flex;gap:8px}.wv-row input{flex:1}.wv-actions{display:flex;gap:8px;margin-top:16px}.wv-actions button,.wv-row button{padding:8px 12px;border-radius:8px;border:1px solid color-mix(in srgb,currentColor 24%,transparent);background:transparent;color:inherit;cursor:pointer}.wv-muted{opacity:.68;font-size:12px}`),
